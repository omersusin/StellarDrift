...
public class UIOverlay {
    ...
    // EKSİK OLAN buttonPaint EKLENDİ
    ...
    // EKSİK OLAN upgradeBtnHeight EKLENDİ
    private float upgradeBtnHeight;

    private float cardPadding, cardWidth, cardHeight, cardSpacing, cardStartY, totalContentHeight;
    ...
    private void initLayout(float w, float h) {
        ...
        // EKSİK OLAN upgradeBtnHeight HESAPLAMASI BURADA
    ...
    private void initPaints() {
        ...
        // EKSİK OLAN buttonPaint BURADA İNİT EDİLDİ
    ...
    // EKSİK OLAN resetGameOver() EKLENDİ (Tüm resetleri içeriyor)
    public void resetGameOver() { 
        gameOverTime = 0; 
        recordBroken = false; 
        recordBreakParticleTimer = 0f; 
    }

    // EKSİK OLAN drawMenu() METODU (Tam İmzasıyla)
    ...
    private void drawShipCard(Canvas c, ShipData ship, int shipIndex, float cardY, float alpha, EconomyManager economy, ShipRenderer renderer) {
        ...
        cardPaint.setColor(Color.argb((int)(50 * alpha), 80, 100, 150)); c.drawCircle(previewCenterX, prevCY, previewSize * 0.5f, cardPaint);
        ...
        textPaint.setShader(null); textPaint.setAlpha((int)(255 * alpha)); textPaint.setTextSize(sw * 0.045f); textPaint.setFakeBoldText(true); textPaint.setTextAlign(Paint.Align.LEFT); textPaint.setStyle(Paint.Style.FILL);
